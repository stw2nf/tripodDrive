...
local picCmdTime
local picTimeout = param:get("TP_TIMEOUT") -- Amount of time (ms) to wait between pictures at a single station -- 4 second picture timeout, past this send another takePic Command we must have missed it
